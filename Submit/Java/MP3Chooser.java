...
public class MP3Chooser{
	...
	//bool gottaPick indicates whether this use of the method, it is necessary for the user to pick a song -Feng
	...
	//this method takes in filePath names and then convert it into a file array with only the mp3s in the name in it -Feng
